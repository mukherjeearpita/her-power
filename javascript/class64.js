...
// document.write("this is " + car.brand + " car.<br> Its color is "+car.color+"<br></br>its price is "+car.price+"$");

// document.getElementById('h').innerHTML="<u style='color:pink'>This is DOM</u>"
// document.getElementById('p').innerHTML="<b style='background-color:blue'>this is a book</b>"
// document.getElementById('a').style.backgroundColor="pink";
// function changecolor(col){
	// document.getElementById('g').style.backgroundColor=col;
// }
function changecolor(){
	let col =document.getElementById('g').style.color;
